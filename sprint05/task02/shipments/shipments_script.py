import random
import sys
from test100 import Cargo, Container, Ship
...
if __name__ == '__main__':
    ...
    destinations = ['Tianjin', 'Antwerp', 'Los Angeles',
                    'Xiamen', 'Bremen', 'Santos', 'Barcelona']
    containers = [] # creating random cargo and containers
